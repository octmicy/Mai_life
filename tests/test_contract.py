...
class ContractTests(unittest.TestCase):
    def test_playwright_release_contract_is_synchronized(self):
        ...
        self.assertEqual(manifest["version"],"1.13.2")
